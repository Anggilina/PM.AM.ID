<%-- 
    Document   : adRiwayat
    Created on : Nov 13, 2018, 1:12:07 AM
    Author     : Maverick
--%>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                                        ...
                                        <div class="latest-from-blog">
                                            <div class="blog-latest">
                                                <div class="row" style="height: 250px ;margin-top: -20px">
                                                    ...
                                                    <div class="col-md-9 col-md-12" style="margin-left:250px">
                ...
                <div class="events-side-panel">
                    ...
                    <br><center><a href="PesanController?proses=max_pesan"> <button class="btn btn-success">Pesanan Terakhir</button></a>
                        <a href="PesanController?proses=min_pesan"> <button class="btn btn-success">Pesanan Awal</button></a></center>
                </div>
            </div>
